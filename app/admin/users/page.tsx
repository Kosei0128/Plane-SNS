...
import { ArrowLeft, Search, Edit, Wallet } from "lucide-react";
...
export default function AdminUsersPage() {
  ...
  const handleSaveBalance = async () => {
    ...
    const token = localStorage.getItem("admin-session");
    console.log("Updating balance for user:", editingUser.id, "to", newBalance);
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl">
            ...
            <div className="mb-4">
              ...
              <p className="mb-4 text-sm text-slate-600">現在の残高: ¥{editingUser.balance.toLocaleString()}</p>
